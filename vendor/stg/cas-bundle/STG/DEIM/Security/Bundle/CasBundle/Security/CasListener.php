...
class CasListener implements ListenerInterface
{
    ...
    public function __construct(SecurityContextInterface $securityContext, AuthenticationManagerInterface $authenticationManager,
        ...
        LoggerInterface $logger = null, CAS $cas, Storage $storage, Client $client, $callbackBaseUrl, $checkPath, $failurePath)
    {
        $this->cas = $cas;
    ...
    private function onFailure(Request $request, AuthenticationException $failed)
    {
        ...
        return new RedirectResponse($this->cas->getLogoutUrl($this->httpUtils->generateUri($request, $this->failurePath)));
    }
