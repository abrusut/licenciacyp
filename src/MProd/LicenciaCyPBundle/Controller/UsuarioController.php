...
class UsuarioController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $queryBuilder = $em->getRepository('MProdLicenciaCyPBundle:Usuario')->createQueryBuilder('e');
    ...
    */
    ...
    public function newAction(Request $request)
    {
        ...
        $usuario = new Usuario();
        $form   = $this->createForm('MProd\LicenciaCyPBundle\Form\UsuarioType', $usuario);
    ...
    {
        $deleteForm = $this->createDeleteForm($usuario);
        $editForm = $this->createForm('MProd\LicenciaCyPBundle\Form\UsuarioType', $usuario);
    ...
    */
    public function bulkAction(Request $request)
    {
        ...
        if ($action == "delete") {
            try {
                $em = $this->getDoctrine()->getManager();
                $repository = $em->getRepository('MProdLicenciaCyPBundle:Usuario');
