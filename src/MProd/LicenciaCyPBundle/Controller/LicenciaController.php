...
class LicenciaController extends Controller
{
    ...
    {
        $this->get('logger')->info("LicenciaController, regenerarBoletaPagoYCodigoBarraAction, licenciaId " . $licenciaId);
        ...
        $this->get('logger')->info("LicenciaController, regenerarBoletaPagoYCodigoBarraAction devuelvo formulario READONLY a la vista");
        return $this->render(
