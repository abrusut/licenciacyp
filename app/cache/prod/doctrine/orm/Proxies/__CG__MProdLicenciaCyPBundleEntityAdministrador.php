 ...
 */
class Administrador extends \MProd\LicenciaCyPBundle\Entity\Administrador implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'cargo', 'id', 'nombre', 'apellido', 'dni', 'email', 'telefono', 'role', 'password', 'isActive', 'salt');
        }
