 ...
 */
class Tecnico extends \MProd\LicenciaCyPBundle\Entity\Tecnico implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'especialidad', 'id', 'nombre', 'apellido', 'dni', 'email', 'telefono', 'role', 'password', 'isActive', 'salt');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Tecnico $proxy) {
