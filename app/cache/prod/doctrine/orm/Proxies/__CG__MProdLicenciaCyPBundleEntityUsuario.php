 ...
 */
class Usuario extends \MProd\LicenciaCyPBundle\Entity\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nombre', 'apellido', 'dni', 'email', 'telefono', 'role', 'password', 'isActive', 'salt');
        }
