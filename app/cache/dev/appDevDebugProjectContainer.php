...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'barcode_service' => 'getBarcodeServiceService',
            'boleta_service' => 'getBoletaServiceService',
            'cache_clearer' => 'getCacheClearerService',
            'cache_warmer' => 'getCacheWarmerService',
            'comprobante_repository' => 'getComprobanteRepositoryService',
            'comprobante_service' => 'getComprobanteServiceService',
            ...
            'encrypt_service' => 'getEncryptServiceService',
            ...
            'json_service' => 'getJsonServiceService',
            ...
            'licencia_repository' => 'getLicenciaRepositoryService',
            'licencia_service' => 'getLicenciaServiceService',
            'locale_listener' => 'getLocaleListenerService',
            'logger' => 'getLoggerService',
            'markup_barcode.base64_encoder' => 'getMarkupBarcode_Base64EncoderService',
            'markup_barcode.definition_provider' => 'getMarkupBarcode_DefinitionProviderService',
            'markup_barcode.factory' => 'getMarkupBarcode_FactoryService',
            'markup_barcode.generator.invoice' => 'getMarkupBarcode_Generator_InvoiceService',
            'markup_barcode.generator.provider' => 'getMarkupBarcode_Generator_ProviderService',
            'markup_barcode.twig.extension' => 'getMarkupBarcode_Twig_ExtensionService',
            'monolog.handler.app_logs' => 'getMonolog_Handler_AppLogsService',
            ...
            'persona_repository' => 'getPersonaRepositoryService',
            'persona_service' => 'getPersonaServiceService',
            'profiler' => 'getProfilerService',
            'profiler_listener' => 'getProfilerListenerService',
            'property_accessor' => 'getPropertyAccessorService',
            'provincia_repository' => 'getProvinciaRepositoryService',
            'provincia_service' => 'getProvinciaServiceService',
            ...
            'security.authentication.session_strategy.page' => 'getSecurity_Authentication_SessionStrategy_PageService',
            ...
            'security.firewall.map.context.page' => 'getSecurity_Firewall_Map_Context_PageService',
            ...
            'security.user_checker.page' => 'getSecurity_UserChecker_PageService',
            ...
            'stg.deim.themes.aplicativo.filtro' => 'getStg_Deim_Themes_Aplicativo_FiltroService',
            'stg.deim.themes.aplicativo.mensajeria_helper' => 'getStg_Deim_Themes_Aplicativo_MensajeriaHelperService',
            'stg.deim.themes.aplicativo.paginator' => 'getStg_Deim_Themes_Aplicativo_PaginatorService',
            'stg.deim.themes.aplicativo.persistance' => 'getStg_Deim_Themes_Aplicativo_PersistanceService',
            'stg.deim.themes.aplicativo.twig.global_data_extension' => 'getStg_Deim_Themes_Aplicativo_Twig_GlobalDataExtensionService',
            'stg.deim.themes.aplicativo.util' => 'getStg_Deim_Themes_Aplicativo_UtilService',
            'stg.deim.themes.aplicativo.validator' => 'getStg_Deim_Themes_Aplicativo_ValidatorService',
            ...
            'tipo_licencia_repository' => 'getTipoLicenciaRepositoryService',
            'tipo_licencia_service' => 'getTipoLicenciaServiceService',
    ...
    /**
     * Gets the public 'barcode_service' shared service.
     *
     * @return \MProd\LicenciaCyPBundle\Service\Barcode\Barcode
     */
    protected function getBarcodeServiceService()
    {
        return $this->services['barcode_service'] = new \MProd\LicenciaCyPBundle\Service\Barcode\Barcode();
    }

    /**
     * Gets the public 'boleta_service' shared autowired service.
     *
     * @return \MProd\LicenciaCyPBundle\Service\BoletaServiceImpl
     */
    protected function getBoletaServiceService()
    {
        return $this->services['boleta_service'] = new \MProd\LicenciaCyPBundle\Service\BoletaServiceImpl($this->get('logger'), $this->get('comprobante_service'));
    }
    ...
    /**
     * Gets the public 'comprobante_repository' shared service.
     *
     * @return \Doctrine\ORM\EntityRepository
     */
    protected function getComprobanteRepositoryService()
    {
        return $this->services['comprobante_repository'] = $this->get('doctrine.orm.default_entity_manager')->getRepository('MProd\\LicenciaCyPBundle\\Entity\\Comprobante');
    }

    /**
     * Gets the public 'comprobante_service' shared autowired service.
     *
     * @return \MProd\LicenciaCyPBundle\Service\ComprobanteServiceImpl
     */
    protected function getComprobanteServiceService()
    {
        return $this->services['comprobante_service'] = new \MProd\LicenciaCyPBundle\Service\ComprobanteServiceImpl($this->get('logger'), $this->get('comprobante_repository'), $this->get('tipo_licencia_service'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'mprod_cazapesca', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array('enum' => 'string', 'set' => 'string'));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/MProd/LicenciaCyPBundle/Entity'))), 'MProd\\LicenciaCyPBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('MProdLicenciaCyPBundle' => 'MProd\\LicenciaCyPBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_1983a6dd96090a46f9815b9d1382b24feae1bc30e0282f2f98fdce1049e8a624');
    ...
    /**
     * Gets the public 'encrypt_service' shared service.
     *
     * @return \MProd\LicenciaCyPBundle\Service\EncryptImpl
     */
    protected function getEncryptServiceService()
    {
        return $this->services['encrypt_service'] = new \MProd\LicenciaCyPBundle\Service\EncryptImpl($this->get('logger'), 'licenciaCyPMinisterioProduccion');
    }
    ...
    /**
     * Gets the public 'json_service' shared autowired service.
     *
     * @return \MProd\LicenciaCyPBundle\Service\JsonServiceImpl
     */
    protected function getJsonServiceService()
    {
        return $this->services['json_service'] = new \MProd\LicenciaCyPBundle\Service\JsonServiceImpl();
    }
    ...
    /**
     * Gets the public 'licencia_repository' shared service.
     *
     * @return \Doctrine\ORM\EntityRepository
     */
    protected function getLicenciaRepositoryService()
    {
        return $this->services['licencia_repository'] = $this->get('doctrine.orm.default_entity_manager')->getRepository('MProd\\LicenciaCyPBundle\\Entity\\Licencia');
    }

    /**
     * Gets the public 'licencia_service' shared autowired service.
     *
     * @return \MProd\LicenciaCyPBundle\Service\LicenciaServiceImpl
     */
    protected function getLicenciaServiceService()
    {
        return $this->services['licencia_service'] = new \MProd\LicenciaCyPBundle\Service\LicenciaServiceImpl($this->get('logger'), $this->get('persona_service'), $this->get('tipo_licencia_service'), $this->get('licencia_repository'), $this->get('comprobante_service'), $this->get('boleta_service'));
    }
    ...
    {
        return $this->services['locale_listener'] = new \Symfony\Component\HttpKernel\EventListener\LocaleListener($this->get('request_stack'), 'es_AR.UTF-8', $this->get('router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getLoggerService()
    {
        ...
        $instance->pushHandler($this->get('monolog.handler.app_logs'));
    ...
    /**
     * Gets the public 'markup_barcode.base64_encoder' shared service.
     *
     * @return \Markup\BarcodeBundle\Generator\Base64Encoder
     */
    protected function getMarkupBarcode_Base64EncoderService()
    {
        return $this->services['markup_barcode.base64_encoder'] = new \Markup\BarcodeBundle\Generator\Base64Encoder();
    }

    /**
     * Gets the public 'markup_barcode.definition_provider' shared service.
     *
     * @return \Markup\BarcodeBundle\Definition\DefinitionProvider
     */
    protected function getMarkupBarcode_DefinitionProviderService()
    {
        return $this->services['markup_barcode.definition_provider'] = new \Markup\BarcodeBundle\Definition\DefinitionProvider();
    }

    /**
     * Gets the public 'markup_barcode.factory' shared service.
     *
     * @return \Markup\BarcodeBundle\Factory\Factory
     */
    protected function getMarkupBarcode_FactoryService()
    {
        return $this->services['markup_barcode.factory'] = new \Markup\BarcodeBundle\Factory\Factory();
    }

    /**
     * Gets the public 'markup_barcode.generator.invoice' shared service.
     *
     * @return \Markup\BarcodeBundle\Generator\Generator
     */
    protected function getMarkupBarcode_Generator_InvoiceService()
    {
        return $this->services['markup_barcode.generator.invoice'] = $this->get('markup_barcode.generator.provider')->getNamedGenerator('invoice');
    }

    /**
     * Gets the public 'markup_barcode.generator.provider' shared service.
     *
     * @return \Markup\BarcodeBundle\Generator\Provider
     */
    ...
    /**
     * Gets the public 'markup_barcode.twig.extension' shared service.
     *
     * @return \Markup\BarcodeBundle\Twig\Extension
     */
    protected function getMarkupBarcode_Twig_ExtensionService()
    {
        return $this->services['markup_barcode.twig.extension'] = new \Markup\BarcodeBundle\Twig\Extension($this->get('markup_barcode.generator.provider'));
    }

    /**
     * Gets the public 'monolog.handler.app_logs' shared service.
     *
    ...
    /**
     * Gets the public 'persona_repository' shared service.
     *
     * @return \Doctrine\ORM\EntityRepository
     */
    protected function getPersonaRepositoryService()
    {
        return $this->services['persona_repository'] = $this->get('doctrine.orm.default_entity_manager')->getRepository('MProd\\LicenciaCyPBundle\\Entity\\Persona');
    }

    /**
     * Gets the public 'persona_service' shared autowired service.
     *
     * @return \MProd\LicenciaCyPBundle\Service\PersonaServiceImpl
     */
    protected function getPersonaServiceService()
    {
        return $this->services['persona_service'] = new \MProd\LicenciaCyPBundle\Service\PersonaServiceImpl($this->get('logger'), $this->get('persona_repository'));
    }
    ...
    /**
     * Gets the public 'provincia_repository' shared service.
     *
     * @return \Doctrine\ORM\EntityRepository
     */
    protected function getProvinciaRepositoryService()
    {
        return $this->services['provincia_repository'] = $this->get('doctrine.orm.default_entity_manager')->getRepository('MProd\\LicenciaCyPBundle\\Entity\\Provincia');
    }

    /**
     * Gets the public 'provincia_service' shared autowired service.
     *
     * @return \MProd\LicenciaCyPBundle\Service\ProvinciaServiceImpl
     */
    protected function getProvinciaServiceService()
    {
        return $this->services['provincia_service'] = new \MProd\LicenciaCyPBundle\Service\ProvinciaServiceImpl($this->get('logger'), $this->get('provincia_repository'));
    }
    ...
    protected function getSecurity_Authentication_GuardHandlerService()
    {
        ...
        $instance->setSessionAuthenticationStrategy($this->get('security.authentication.session_strategy.page'));

        return $instance;
    }

    /**
     * Gets the public 'security.authentication.session_strategy.page' shared service.
     *
     * @return \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy
     */
    protected function getSecurity_Authentication_SessionStrategy_PageService()
    {
        return $this->services['security.authentication.session_strategy.page'] = new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate');
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('MProd\\LicenciaCyPBundle\\Entity\\Usuario' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 12))));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.page' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/*'))), $this->get('debug.event_dispatcher'));
    }

    /**
     * Gets the public 'security.firewall.map.context.page' shared service.
     *
     * @return \Symfony\Bundle\SecurityBundle\Security\FirewallContext
     */
    protected function getSecurity_Firewall_Map_Context_PageService()
    {
        ...
        $h = $this->get('security.authentication.session_strategy.page');
        ...
        $k = new \Symfony\Component\Security\Http\HttpUtils($e, $e, '{^https?://%s$}i');
        ...
        $n = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), 'licencia1234', 'page', array('lifetime' => 3600, 'name' => 'REMEMBERME', 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);

        $o = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, $h, $k, 'page', $l, $m, array('check_path' => 'login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $d, NULL);
        $o->setRememberMeServices($n);

        $p = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $k, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($k, 'login'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'logout'));
    ...
    /**
     * Gets the public 'security.user_checker.page' shared service.
     *
     * @return \Symfony\Component\Security\Core\User\UserChecker
     */
    protected function getSecurity_UserChecker_PageService()
    {
        return $this->services['security.user_checker.page'] = new \Symfony\Component\Security\Core\User\UserChecker();
    }
    ...
    /**
     * Gets the public 'stg.deim.themes.aplicativo.controller.exception' shared service.
     *
     * @return \STG\DEIM\Themes\Bundles\AplicativoBundle\Controller\ExceptionController
     */
    protected function getStg_Deim_Themes_Aplicativo_Controller_ExceptionService()
    {
        return $this->services['stg.deim.themes.aplicativo.controller.exception'] = new \STG\DEIM\Themes\Bundles\AplicativoBundle\Controller\ExceptionController($this->get('twig'), true, $this->get('security.context'), $this->get('router'), $this->get('session'));
    }

    /**
     * Gets the public 'stg.deim.themes.aplicativo.custom_logger' shared service.
     *
     * @return \STG\DEIM\Themes\Bundles\AplicativoBundle\Services\CustomLoggerService
     *
     * @throws InactiveScopeException when the 'stg.deim.themes.aplicativo.custom_logger' service is requested while the 'request' scope is not active
     */
    protected function getStg_Deim_Themes_Aplicativo_CustomLoggerService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('stg.deim.themes.aplicativo.custom_logger', 'request');
        }

        return $this->services['stg.deim.themes.aplicativo.custom_logger'] = $this->scopedServices['request']['stg.deim.themes.aplicativo.custom_logger'] = new \STG\DEIM\Themes\Bundles\AplicativoBundle\Services\CustomLoggerService($this->get('logger'), $this->get('request'), $this->get('router'));
    }

    /**
     * Gets the public 'stg.deim.themes.aplicativo.exception_handler' shared service.
     *
     * @return \STG\DEIM\Themes\Bundles\AplicativoBundle\Services\ExceptionHandlerService
     *
     * @throws InactiveScopeException when the 'stg.deim.themes.aplicativo.exception_handler' service is requested while the 'request' scope is not active
     */
    protected function getStg_Deim_Themes_Aplicativo_ExceptionHandlerService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('stg.deim.themes.aplicativo.exception_handler', 'request');
        }

        return $this->services['stg.deim.themes.aplicativo.exception_handler'] = $this->scopedServices['request']['stg.deim.themes.aplicativo.exception_handler'] = new \STG\DEIM\Themes\Bundles\AplicativoBundle\Services\ExceptionHandlerService($this->get('stg.deim.themes.aplicativo.custom_logger'), $this->get('stg.deim.themes.aplicativo.mensajeria_helper'));
    }

    /**
     * Gets the public 'stg.deim.themes.aplicativo.filtro' shared service.
     *
     * @return \STG\DEIM\Themes\Bundles\AplicativoBundle\Services\FiltroService
     *
     * @throws InactiveScopeException when the 'stg.deim.themes.aplicativo.filtro' service is requested while the 'request' scope is not active
     */
    protected function getStg_Deim_Themes_Aplicativo_FiltroService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('stg.deim.themes.aplicativo.filtro', 'request');
        }

        return $this->services['stg.deim.themes.aplicativo.filtro'] = $this->scopedServices['request']['stg.deim.themes.aplicativo.filtro'] = new \STG\DEIM\Themes\Bundles\AplicativoBundle\Services\FiltroService($this->get('doctrine.orm.default_entity_manager'), $this->get('request'));
    }

    /**
     * Gets the public 'stg.deim.themes.aplicativo.mensajeria_helper' shared service.
     *
     * @return \STG\DEIM\Themes\Bundles\AplicativoBundle\Services\MensajeriaHelperService
     */
    protected function getStg_Deim_Themes_Aplicativo_MensajeriaHelperService()
    {
        return $this->services['stg.deim.themes.aplicativo.mensajeria_helper'] = new \STG\DEIM\Themes\Bundles\AplicativoBundle\Services\MensajeriaHelperService($this->get('session'), $this->get('translator'));
    }

    /**
     * Gets the public 'stg.deim.themes.aplicativo.paginator' shared service.
     *
     * @return \STG\DEIM\Themes\Bundles\AplicativoBundle\Services\PaginatorService
     *
     * @throws InactiveScopeException when the 'stg.deim.themes.aplicativo.paginator' service is requested while the 'request' scope is not active
     */
    protected function getStg_Deim_Themes_Aplicativo_PaginatorService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('stg.deim.themes.aplicativo.paginator', 'request');
        }

        return $this->services['stg.deim.themes.aplicativo.paginator'] = $this->scopedServices['request']['stg.deim.themes.aplicativo.paginator'] = new \STG\DEIM\Themes\Bundles\AplicativoBundle\Services\PaginatorService($this->get('knp_paginator'), $this->get('request'));
    }

    /**
     * Gets the public 'stg.deim.themes.aplicativo.persistance' shared service.
     *
     * @return \STG\DEIM\Themes\Bundles\AplicativoBundle\Services\PersistanceService
     *
     * @throws InactiveScopeException when the 'stg.deim.themes.aplicativo.persistance' service is requested while the 'request' scope is not active
     */
    protected function getStg_Deim_Themes_Aplicativo_PersistanceService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('stg.deim.themes.aplicativo.persistance', 'request');
        }

        return $this->services['stg.deim.themes.aplicativo.persistance'] = $this->scopedServices['request']['stg.deim.themes.aplicativo.persistance'] = new \STG\DEIM\Themes\Bundles\AplicativoBundle\Services\PersistanceService($this->get('doctrine.orm.default_entity_manager'), $this->get('stg.deim.themes.aplicativo.mensajeria_helper'), $this->get('stg.deim.themes.aplicativo.custom_logger'), $this->get('stg.deim.themes.aplicativo.exception_handler'));
    }

    /**
     * Gets the public 'stg.deim.themes.aplicativo.twig.global_data_extension' shared service.
     *
     * @return \STG\DEIM\Themes\Bundles\AplicativoBundle\Twig\GlobalDataExtension
     */
    protected function getStg_Deim_Themes_Aplicativo_Twig_GlobalDataExtensionService()
    {
        return $this->services['stg.deim.themes.aplicativo.twig.global_data_extension'] = new \STG\DEIM\Themes\Bundles\AplicativoBundle\Twig\GlobalDataExtension($this);
    }

    /**
     * Gets the public 'stg.deim.themes.aplicativo.util' shared service.
     *
     * @return \STG\DEIM\Themes\Bundles\AplicativoBundle\Services\UtilService
     */
    protected function getStg_Deim_Themes_Aplicativo_UtilService()
    {
        return $this->services['stg.deim.themes.aplicativo.util'] = new \STG\DEIM\Themes\Bundles\AplicativoBundle\Services\UtilService($this->get('session'));
    }

    /**
     * Gets the public 'stg.deim.themes.aplicativo.validator' shared service.
     *
     * @return \STG\DEIM\Themes\Bundles\AplicativoBundle\Services\ValidatorService
     */
    protected function getStg_Deim_Themes_Aplicativo_ValidatorService()
    {
        return $this->services['stg.deim.themes.aplicativo.validator'] = new \STG\DEIM\Themes\Bundles\AplicativoBundle\Services\ValidatorService($this->get('validator'));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $instance->setHost('correo.santafe.gov.ar');
        $instance->setPort(25);
    ...
    /**
     * Gets the public 'tipo_licencia_repository' shared service.
     *
     * @return \Doctrine\ORM\EntityRepository
     */
    protected function getTipoLicenciaRepositoryService()
    {
        return $this->services['tipo_licencia_repository'] = $this->get('doctrine.orm.default_entity_manager')->getRepository('MProd\\LicenciaCyPBundle\\Entity\\TipoLicencia');
    }

    /**
     * Gets the public 'tipo_licencia_service' shared autowired service.
     *
     * @return \MProd\LicenciaCyPBundle\Service\TipoLicenciaServiceImpl
     */
    protected function getTipoLicenciaServiceService()
    {
        return $this->services['tipo_licencia_service'] = new \MProd\LicenciaCyPBundle\Service\TipoLicenciaServiceImpl($this->get('logger'), $this->get('tipo_licencia_repository'));
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => (__DIR__.'/translations'), 'debug' => true, 'resource_files' => array('en' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.en.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.en.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.en.xlf'), 3 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.en.xliff')), 'ro' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ro.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ro.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ro.xlf'), 3 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.ro.xliff')), 'id' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.id.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.id.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.id.xlf'), 3 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.id.xliff')), 'sr_Latn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Latn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Latn.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sr_Latn.xlf')), 'pt' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt.xlf')), 'fr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.fr.xlf'), 3 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.fr.xliff'), 4 => ($this->targetDirs[3].'/src/MProd/LicenciaCyPBundle/Resources/translations/messages.fr.xlf')), 'mn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.mn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.mn.xlf')), 'cs' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cs.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.cs.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.cs.xlf')), 'gl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.gl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.gl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.gl.xlf')), 'tl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.tl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.tl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.tl.xlf')), 'sr_Cyrl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Cyrl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Cyrl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sr_Cyrl.xlf')), 'hr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.hr.xlf')), 'sk' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sk.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sk.xlf')), 'ar' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ar.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ar.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ar.xlf'), 3 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.ar.xliff')), 'et' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.et.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.et.xlf')), 'nb' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nb.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.nb.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.nb.xlf')), 'zh_TW' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_TW.xlf')), 'sl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sl.xlf')), 'lv' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lv.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lv.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lv.xlf')), 'ja' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ja.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ja.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ja.xlf')), 'no' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.no.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.no.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.no.xlf')), 'hu' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hu.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.hu.xlf'), 3 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.hu.xliff')), 'th' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.th.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.th.xlf')), 'hy' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hy.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hy.xlf')), 'eu' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.eu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.eu.xlf')), 'pt_BR' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt_BR.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt_BR.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pt_BR.xlf'), 3 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.pt_BR.xliff')), 'zh_CN' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_CN.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.zh_CN.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.zh_CN.xlf')), 'nl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.nl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.nl.xlf'), 3 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.nl.xliff')), 'de' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.de.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.de.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.de.xlf'), 3 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.de.xliff')), 'it' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.it.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.it.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.it.xlf'), 3 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.it.xliff')), 'lt' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lt.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lt.xlf'), 3 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.lt.xliff')), 'el' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.el.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.el.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.el.xlf')), 'af' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.af.xlf')), 'vi' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.vi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.vi.xlf')), 'ru' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ru.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ru.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ru.xlf'), 3 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.ru.xliff')), 'sv' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sv.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sv.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sv.xlf'), 3 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.sv.xliff')), 'nn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.nn.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.nn.xlf')), 'he' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.he.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.he.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.he.xlf')), 'pl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pl.xlf'), 3 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.pl.xliff')), 'es' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.es.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.es.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.es.xlf'), 3 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.es.xliff')), 'cy' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cy.xlf')), 'ca' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ca.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ca.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ca.xlf')), 'da' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.da.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.da.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.da.xlf'), 3 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.da.xliff')), 'lb' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lb.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lb.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lb.xlf')), 'az' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.az.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.az.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.az.xlf')), 'fa' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fa.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fa.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.fa.xlf'), 3 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.fa.xliff')), 'uk' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.uk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.uk.xlf'), 2 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.uk.xliff')), 'sq' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sq.xlf')), 'bg' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.bg.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.bg.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.bg.xlf')), 'tr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.tr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.tr.xlf')), 'fi' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fi.xlf')), 'pt_PT' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pt_PT.xlf')), 'ua' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ua.xlf')), 'sw' => array(0 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.sw.xliff')), 'ky' => array(0 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.ky.xliff')))), array());

        $instance->setConfigCacheFactory($this->get('config_cache_factory'));
        $instance->setFallbackLocales(array(0 => 'es_AR.UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/stg/theme-bundle/STG/DEIM/Themes/Bundles/AplicativoBundle/Resources/views'), 'ThemeAplicativo');
        $instance->addPath(($this->targetDirs[3].'/src/MProd/LicenciaCyPBundle/Resources/views'), 'MProdLicenciaCyP');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('2474fa53cf18a3fa7c197b5835c5e10f9');
    }
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('page', 'logout', 'logout', '_csrf_token', NULL);
    ...
    {
        return $this->services['security.user.provider.concrete.usuarios'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'MProd\\LicenciaCyPBundle\\Entity\\Usuario', 'email', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles_metadata' => array(
                ...
                'ThemeAplicativoBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/vendor/stg/theme-bundle/STG/DEIM/Themes/Bundles/AplicativoBundle'),
                    'namespace' => 'STG\\DEIM\\Themes\\Bundles\\AplicativoBundle',
                ),
                'MProdLicenciaCyPBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/MProd/LicenciaCyPBundle'),
                    'namespace' => 'MProd\\LicenciaCyPBundle',
                ),
                ...
                'MarkupBarcodeBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/vendor/markup/barcode-bundle/Markup/BarcodeBundle'),
            ...
            'database_port' => NULL,
            'database_name' => 'mprod_cazapesca',
            'database_user' => 'root',
            'database_password' => 'root',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'correo.santafe.gov.ar',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '2474fa53cf18a3fa7c197b5835c5e10f9',
            'locale' => 'es_AR.UTF-8',
            ...
            'kernel.secret' => '2474fa53cf18a3fa7c197b5835c5e10f9',
            ...
            'kernel.default_locale' => 'es_AR.UTF-8',
            ...
            'monolog.handlers_to_channels' => array(
                'monolog.handler.app_logs' => array(
                    'type' => 'exclusive',
                    'elements' => array(
                        0 => 'doctrine',
                        1 => 'main',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'correo.santafe.gov.ar',
            ...
            'theme_aplicativo.datos_aplicativo.encabezado.webmaster_correo' => 'agespinosa@santafe.gov.ar',
            'theme_aplicativo.datos_aplicativo.encabezado.path_ayuda' => '',
            'theme_aplicativo.datos_aplicativo.encabezado.path_logout' => 'logout',
            'theme_aplicativo.datos_aplicativo.encabezado.path_home' => 'path_home',
            'theme_aplicativo.datos_aplicativo.pie_pagina.titulo' => '<img src="https://www.santafe.gob.ar/assets/app/portal/imgs/marca-footer.png" alt="Gobierno de Santa Fe" style="padding-bottom:10px;">',
            'theme_aplicativo.datos_aplicativo.pie_pagina.domicilio' => 'Atención telefónica: 0800-777-0801',
            'theme_aplicativo.datos_aplicativo.pie_pagina.telefono' => 'Lunes a viernes de 8 a 18 hs',
            'theme_aplicativo.datos_aplicativo.pie_pagina.copyright' => 'Atribución-CompartirIgual 2.5 Argentina',
            'keysalt' => 'licenciaCyPMinisterioProduccion',
            'barcode_directory' => ($this->targetDirs[2].'/../web/barcode/'),
            ...
            'markup_barcode.generator.class' => 'Markup\\BarcodeBundle\\Generator\\Generator',
            'markup_barcode.factory.class' => 'Markup\\BarcodeBundle\\Factory\\Factory',
            'markup_barcode.base64_encoder.class' => 'Markup\\BarcodeBundle\\Generator\\Base64Encoder',
            'markup_barcode.definition_provider.class' => 'Markup\\BarcodeBundle\\Definition\\DefinitionProvider',
